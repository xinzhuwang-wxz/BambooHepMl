...
from bamboohepml.data.features.processors import FeatureProcessor  # noqa: E402
...
def test_dependency_resolution():
    ...
    features = {
        ...
        "met_ht_ratio": {"expr": "met / (ht + 1e-6)", "type": "event", "dependencies": ["met", "ht"]},
        "jet_pt": {"expr": "Jet.pt", "type": "object"},
        "jet_pt_log": {"expr": "log1p(Jet.pt)", "type": "object", "dependencies": ["jet_pt"]},
    }
