...
from bamboohepml.data import (
    DataSourceFactory,
    HEPDataset,
    DataConfig,
)
from bamboohepml.data.features import FeatureGraph, ExpressionEngine
...
def test_different_types():
    ...
    # vector<bool> 类型
    vector_bool_branches = [b for b in branches if 'part_is' in b.lower() and ('electron' in b.lower() or 'muon' in b.lower() or 'photon' in b.lower())]
